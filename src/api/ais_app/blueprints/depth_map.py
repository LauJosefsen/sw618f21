...
def generate_depth_map_interpolated(
    ...
    #
    # depths, varians = depth_map_service.interpolate_depth_map_in_enc(enc_cell_id, enc_bounds, grid_size)
    #
    # depth_map_service.insert_interpolated_depth_map(enc_bounds, grid_size, depths, varians)
