...
app.add_url_rule("/import_enc", "import_enc", controller.ais_data_controller.import_enc_data)
app.add_url_rule("/get_enc_cells", "get_enc_cells", controller.ais_data_controller.get_enc_cells)
